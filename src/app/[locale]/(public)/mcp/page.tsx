...
import { mcpDocsMarkdown } from "@/components/docs/mcp-docs-content";
import { mcpDocsMarkdownFr } from "@/components/docs/mcp-docs-content-fr";
import { MarkdownRenderer } from "@/components/shared/MarkdownRenderer";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Download, Server, Search, X } from "lucide-react";
...
export default function McpDocsPage() {
  ...
  const content = locale === "fr" ? mcpDocsMarkdownFr : mcpDocsMarkdown;
  ...
  const handleSaveMarkdown = () => {
    ...
    a.href = url;
    a.download = "kopern-mcp-documentation.md";
    a.click();
  ...
  return (
    <div className="flex h-[calc(100vh-8rem)] gap-0 -mx-6 -mt-6">
      ...
      <aside className="hidden xl:flex w-64 shrink-0 border-r flex-col overflow-y-auto py-6 pr-6 pl-4">
        {mounted && <TableOfContents contentRef={scrollRef} contentKey={`mcp-docs-${locale}`} />}
      </aside>
        ...
        <div className="mx-auto max-w-5xl px-6 py-6">
          ...
          <div className="relative mb-8 max-w-2xl" data-search-container>
            ...
            <Input
              ...
              onKeyDown={onKeyDown}
              placeholder={locale === "fr" ? "Rechercher dans la doc MCP..." : "Search MCP docs..."}
